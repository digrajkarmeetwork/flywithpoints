    ...
    >
      <Card className={cn('border-l-4 overflow-hidden transition-shadow hover:shadow-md', getAccentColor())}>
        <CardContent className="p-4">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{formatCabinClass(sweetSpot.cabinClass)}</p>
              </div>
            </div>
          ...
          <h3 className="font-semibold text-foreground mb-1 line-clamp-1">{sweetSpot.title}</h3>
          <p className="text-sm text-muted-foreground mb-3 line-clamp-2">{sweetSpot.description}</p>
            ...
            <div className="flex items-center justify-between">
              {canAfford ? (
                ...
                <div className="text-sm text-muted-foreground">
                  Need <span className="font-medium text-foreground">{pointsShortfall.toLocaleString()}</span> more points
                </div>
              )}
