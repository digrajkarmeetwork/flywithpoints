          ...
          <Popover open={airlineOpen} onOpenChange={setAirlineOpen}>
            <PopoverTrigger asChild>
              <Button
                ...
                className="w-full h-12 justify-between border-border font-normal"
              >
                {selectedAirline ? (
                  <div className="flex items-center gap-2">
                    <Plane className="h-4 w-4 text-muted-foreground" />
                    <span>{selectedAirline.name}</span>
                    <span className="text-muted-foreground">({selectedAirline.code})</span>
                  </div>
                ) : (
                  <span className="text-muted-foreground">Choose an airline...</span>
                )}
        ...
        <div className="flex items-end">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full">
            <Button
              ...
              className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-medium md:w-auto md:px-8"
            >
